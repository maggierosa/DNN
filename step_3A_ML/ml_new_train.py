...
stride=100 # stride of sample input

checkpoint_load = './' # path to the weight in previous training section. Not used in a newly built DNN
...
#model.load_weights(checkpoint_load + 'Previous_best.hdf5')
print(model.summary())
