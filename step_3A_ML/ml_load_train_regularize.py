...
nb_epoch = 50 # training epoch number
...
checkpoint_load = './checkpoints_fullset_lr0.0001/' # path to the weight in previous training section. Not used in a newly built DNN
checkpoint_save = './checkpoints_regularize_lr%s/'%(stride,lr) # path to weight
...
model.load_weights(checkpoint_load + 'weights_best_val_loss.hdf5') #load the weight with best performance from last step to continue training
print(model.summary())
