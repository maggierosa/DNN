...
stride=10 # stride of sample input

checkpoint_load = './checkpoints_stride100_lr0.0001/' # path to the weight in previous training section. Not used in a newly built DNN
checkpoint_save = './checkpoints_stride%d_lr%s/'%(stride,lr) # path to weight
...
model.load_weights(checkpoint_load + 'weights_newest.hdf5') #load the newest weight from last step with stride100 to continue training
print(model.summary())
