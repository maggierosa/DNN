...
## User parameters ####################
lr = 0 #not required for evaluation
...
checkpoint_save = './' # path to weight, not used in evaluation
...
# don't Fit the model in evaluation
...
# don't save the history of accuracy and loss 
